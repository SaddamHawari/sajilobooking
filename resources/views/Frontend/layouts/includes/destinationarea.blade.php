        ...
        <div class="row padding-top-50px">
            <div class="col-lg-4">
                <div class="card-item destination-card">
                    <div class="card-img">
                        <img src="{{asset('img/images/destination-img2.jpg')}}" alt="destination-img">
                ...
                <div class="card-item destination-card">
                    <div class="card-img">
                        <img src="{{asset('img/images/destination-img3.jpg')}}" alt="destination-img">
            ...
            <div class="col-lg-4">
                <div class="card-item destination-card">
                    <div class="card-img">
                        <img src="{{asset('img/images/destination-img4.jpg')}}" alt="destination-img">
                ...
                <div class="card-item destination-card">
                    <div class="card-img">
                        <img src="{{asset('img/images/destination-img5.jpg')}}" alt="destination-img">
            ...
            <div class="col-lg-4">
                <div class="card-item destination-card">
                    <div class="card-img">
                        <img src="{{asset('img/images/destination-img.jpg')}}" alt="destination-img">
