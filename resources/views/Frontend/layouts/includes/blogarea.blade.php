        ...
        <div class="row padding-top-50px">
            <div class="col-lg-4 responsive-column">
                <div class="card-item blog-card">
                    <div class="card-img">
                        <img src="{{asset('img/images/blog-img.jpg')}}" alt="blog-img">
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <div class="author-content d-flex align-items-center">
                            <div class="author-img">
                                <img src="{{asset('img/images/small-team1.jpg')}}" alt="testimonial image">
                            </div>
            ...
            <div class="col-lg-4 responsive-column">
                <div class="card-item blog-card">
                    <div class="card-img">
                        <img src="{{asset('img/images/blog-img2.jpg')}}" alt="blog-img">
                        <div class="post-format icon-element">
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <div class="author-content d-flex align-items-center">
                            <div class="author-img">
                                <img src="{{asset('img/images/small-team2.jpg')}}" alt="testimonial image">
                            </div>
                            <div class="author-bio">
            ...
            <div class="col-lg-4 responsive-column">
                <div class="card-item blog-card">
                    <div class="card-img">
                        <img src="{{asset('img/images/blog-img3.jpg')}}" alt="blog-img">
                        <div class="post-format icon-element">
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <div class="author-content d-flex align-items-center">
                            <div class="author-img">
                                <img src="{{asset('img/images/small-team3.jpg')}}" alt="testimonial image">
                            </div>
                            <div class="author-bio">
