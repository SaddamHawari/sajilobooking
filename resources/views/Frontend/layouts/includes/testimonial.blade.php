            ...
            <div class="col-lg-8">
                <div class="testimonial-carousel carousel-action">
                    <div class="testimonial-card">
                        ...
                        <div class="author-content d-flex align-items-center">
                            <div class="author-img">
                                <img src="{{asset('img/images/team8.jpg')}}" alt="testimonial image">
                            </div>
                    ...
                    <div class="testimonial-card">
                        ...
                        <div class="author-content d-flex align-items-center">
                            <div class="author-img">
                                <img src="{{asset('img/images/team9.jpg')}}" alt="testimonial image">
                            </div>
                            <div class="author-bio">
                    ...
                    <div class="testimonial-card">
                        ...
                        <div class="author-content d-flex align-items-center">
                            <div class="author-img">
                                <img src="{{asset('img/images/team10.jpg')}}" alt="testimonial image">
                            </div>
                            <div class="author-bio">
