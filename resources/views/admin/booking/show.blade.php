            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('admin/booking' . '/' . $booking->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Name </th><td> {{ $booking->name }} </td></tr><tr><th> Email </th><td> {{ $booking->email }} </td></tr><tr><th> User Id </th><td> {{ $booking->user_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
